...
if __name__ == '__main__':
    rospy.init_node('navigation_transport', anonymous=True)
    ...
    rospy.Service('/navigation_transport/pick', SetPose2D, start_pick_srv_callback)
    rospy.Service('/navigation_transport/place', SetPose2D, start_place_srv_callback)
